...
# ╔═╡ 8e35a678-96e7-42cd-abc2-234cde26bbaf
@bind r Slider(0:0.1:1, show_value=true)

# ╔═╡ 6d3b6443-1c2f-49ee-be2e-f1d3e9feca28
@bind g Slider(0:0.1:1, show_value=true)

# ╔═╡ 309d0f9c-76d1-4753-8dcb-376ea72cfa56
@bind b Slider(0:0.1:1, show_value=true)

# ╔═╡ a8314829-c4c2-4ab7-8d7e-624dca170765
color_patch = RGB(r, g, b)
...
# ╔═╡ 48fac1b2-3756-4dee-a609-fa44bffee236
@bind reds Slider(0.1:0.1:1, show_value=true)

# ╔═╡ 951fdccc-b3eb-4940-a72e-34ab363380e4
@bind greens Slider(0.1:0.1:1, show_value=true)

# ╔═╡ ef4ff48e-97c7-41a2-b666-c9336615de1f
[RGB(i, j, 0) for i in 0:0.1:reds, j in 0:0.1:greens]
